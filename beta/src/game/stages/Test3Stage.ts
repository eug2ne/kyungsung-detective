...
const event_config = {
  ...
  'z2Aj8sLVTc5FLNxZQ0Rg': [
    ...
    new Update({id: "test3_item0", data: "item0-get"}, () => {
      ...
      const item = {
        ...
        descript: "최영길 군 자택 창문 아래에서 떨어져있는 걸 발견했다.",
        texture: "shoe.png"
      }
      useGameStore().$patch((state: any) => {
    ...
    new Update({quiz_id: "WIN3vIY76B5ZHa13x70c", route: "2.4.2"}, () => {
  ...
  'test3-event-updateTimeline': [
    ...
    new Update({id: "test3_villager12", data: "villager12-time"}, () => {
      ...
      if (timeline_complete === 1) {
        // if timeline complete, activate suspicion system
    ...
    new Update({id: "test3_missing1mom", data: "missing1mom-time"}, () => {
    ...
    new Update({id: "test3_missing1sis", data: "missing1sis-time"}, () => {
      // add timeline
      const timeline_complete = addTimeline({
        title: "15:15 가량",
    ...
    new Update({id: "test3_missing2mom", data: "missing2mom-time"}, () => {
      // add timeline
      const timeline = _.cloneDeep(useGameStore().cluenote[2].timelineData.timeline)
    ...
    new Update({id: "test3_missing3mom", data: "missing3mom-time"}, () => {
      // add timeline
      const timeline = _.cloneDeep(useGameStore().cluenote[2].timelineData.timeline)
  ...
  '5pSYFHRok3Es4xw6XWcC': [
    ...
    new Update({quiz_id: "WIN3vIY76B5ZHa13x70c", route: "2.0.3"}, () => {
    ...
    new Update({id: "test3_inspector", data: "inspector-solve"}, () => {
      // stage clear
      return true
    })
  ]
